...
import StockManagement from '../views/owner/stock/StockMain.vue';
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "/app/owner/stock-management", // រក្សា path ចាស់ដដែល ដើម្បីកុំឱ្យដាច់លីងពី Menu
          name: "StockManagement",
          component: StockMain, // ដូរមកប្រើ Component ថ្មីនេះ
