    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar scroll-smooth relative pb-40">
       <div class="px-4 md:px-8 py-6 max-w-7xl mx-auto w-full">
         ...
         <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-8">
            <div class="bg-gradient-to-br from-indigo-600 via-purple-600 to-fuchsia-600 rounded-[24px] p-6 text-white shadow-xl shadow-indigo-500/20 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
            ...
            <div class="bg-white rounded-[24px] p-6 border border-slate-200/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden flex flex-col justify-between group hover:border-blue-300 transition-colors">
                ...
                <div class="relative z-10 flex justify-between items-start mb-4">
                   <div>
                      <p class="text-slate-400 text-[11px] font-black uppercase tracking-widest mb-1">អតិថិជនសរុប</p>
                ...
                <div class="relative z-10 pt-3 border-t border-slate-100 flex flex-col gap-2">
                   <p class="text-slate-400 text-[10px] font-black uppercase tracking-widest">បរិមាណលក់សរុប (Units Sold)</p>
            ...
            <div class="bg-white rounded-[24px] p-6 border border-slate-200/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden flex flex-col justify-center group hover:border-emerald-300 transition-colors">
                <p class="text-slate-400 text-[11px] font-black uppercase tracking-widest mb-4">ស្ថិតិតំណាងលក់ (Sellers Stat)</p>
                <div class="space-y-3">
                   <div class="flex items-center justify-between p-2.5 rounded-xl bg-slate-50 border border-slate-100">
                      <div class="flex items-center gap-2">
                         <div class="w-2 h-2 rounded-full bg-slate-400"></div>
                         <span class="text-xs font-bold text-slate-600">សរុបទាំងអស់ (Total)</span>
                      </div>
                   ...
                   <div class="flex items-center justify-between p-2.5 rounded-xl bg-emerald-50 border border-emerald-100">
                      <div class="flex items-center gap-2">
                         ...
                         <span class="text-xs font-bold text-emerald-700">លក់បាន (Active)</span>
                      </div>
                      <span class="font-black text-emerald-700">{{ activeSellersCount }}</span>
                   </div>
                   <div class="flex items-center justify-between p-2.5 rounded-xl bg-rose-50 border border-rose-100">
                      <div class="flex items-center gap-2">
                         ...
                         <span class="text-xs font-bold text-rose-700">មិនបានលក់ (Inactive)</span>
                      </div>
                      <span class="font-black text-rose-700">{{ inactiveSellersCount }}</span>
                   </div>
                </div>
            </div>
         </div>
               ...
               <table class="w-full text-left border-collapse">
                  <thead class="bg-slate-50/80 text-slate-500 text-[11px] uppercase font-black tracking-widest border-b border-slate-200">
                     <tr>
                        ...
                        <th class="px-6 py-5 text-center">ភ្ញៀវ</th>
                        <th class="px-6 py-5 text-right">ចំណូល (Revenue)</th>
                        ...
                        <td class="px-6 py-5">
                           <div class="flex items-center gap-4">
                              ...
                              <div>
                                 ...
                                 <div class="flex items-center gap-2">
                                    <span class="text-[10px] bg-white text-slate-500 px-1.5 py-0.5 rounded border border-slate-200 font-mono font-bold">{{ item.idNumber || 'N/A' }}</span>
                                 </div>
                              </div>
                           </div>
                        </td>
...
const activityFilter = ref('all'); // NEW: 'all', 'active', 'inactive'
...
const baseCalculatedData = computed(() => {
   ...
   return sellers.value.map(seller => {
      ...
      return { ...seller, unitCounts, totalClients, revenueUSD, revenueKHR, hasSales };
   }).sort((a, b) => {
       // Sort: Active first, then by revenue, then inactive
...
// 4. Grand Totals (Calculated from Base Data so top cards are always accurate)
